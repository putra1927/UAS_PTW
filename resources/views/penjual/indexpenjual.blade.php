        ...
        <div class="col-md-8 mt-1" style="justify-content: space-between;">
            <div class="card" style="width: 200%;">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            <img src="{{ asset('img/lgo.jpg') }}" alt="" width="300" class="rounded-circle mt-1" style="border: 3px #ccc; margin-left: 16px; box-shadow:0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                        </div>
